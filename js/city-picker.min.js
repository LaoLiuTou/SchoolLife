...
+ function(e) {
   ...
   e.rawCitiesData = [{
    ...
    if(e.rawCitiesData.length>0){
        var first=e.rawCitiesData[0].name;
        var second=e.rawCitiesData[0].sub[0].name;
        var third=e.rawCitiesData[0].sub[0].sub[0].name;
	...
	var n, a = e.rawCitiesData,
		...
		m = function(e) {
			for(var n = 0; n < a.length; n++)
				if(a[n].id === e || a[n].name === e) return o(a[n]);
			return []
		},
		d = function(e, n) {
			for(var c = 0; c < a.length; c++)
				if(a[c].id === e || a[c].name === e)
					for(var m = 0; m < a[c].sub.length; m++)
						if(a[c].sub[m].id === n || a[c].sub[m].name === n) return o(a[c].sub[m])
		},
		u = function(e) {
			var n, c, o = a[0],
				m = e.split(" ");
		...
		return c = e.extend({}, n, c), this.each(function() {
			...
			var g = {
				...
				onChange: function(a, o, u) {
					...
					e(n).attr("data-id", o[l]), e(n).attr("data-ids", o.join(",")), c.onChange && c.onChange.call(n, a, o, u)
				},
				cols: y
			};
			if(this) {
				...
				if(w||(w = firstValue), v = w.split(" ")[0], h = w.split(" ")[1], V = w.split(" ")[2], w) {
